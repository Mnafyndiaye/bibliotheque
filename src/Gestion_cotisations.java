 ...
 * @author DELL
 */
public class Gestion_cotisations extends javax.swing.JFrame {

    /**
     * Creates new form Gestion_utilisateurs
     */
    public Gestion_cotisations () {
        initComponents();
        chargerDonneesCotisations();
        ...
        this.setTitle("Gestion cotisations");
    ...
    jPanelDropdownBlack.setEnabled(true);
        ...
        jTable1_GestionCotisations.getColumnModel().getColumn(5).setCellRenderer(new TableActionCellRendue());
        jTable1_GestionCotisations.getColumnModel().getColumn(5).setCellEditor(new TableActionsCellEditor(event));
         
        
    }
    
    // Affichage de la table utilisateurs
    private void chargerDonneesCotisations() {
    PreparedStatement ps;
    ResultSet rs;
    
    // Table utilisateurs de la bdd bibliotheque
    String query = "SELECT * FROM cotisations";
    
    try {
        ps = MyConnection.getConnection().prepareStatement(query);
        rs = ps.executeQuery();
        
        DefaultTableModel model = (DefaultTableModel) jTable1_GestionCotisations.getModel();
        model.setRowCount(0);
        
        while (rs.next()) {
            Object[] row = {
                rs.getInt("idCotisation"),
                rs.getInt("idUtili"),
                rs.getDate("Date_cotisation"),
                rs.getInt("Montant"),
                rs.getInt("Etat"),
            };
            model.addRow(row);
    ...
    private void initComponents() {
        ...
        jTable1_GestionCotisations = new javax.swing.JTable();
        ...
        jTable1_GestionCotisations.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "idUtilisateur", "Date de la Cotisation", "Montant Cotisation", "Etat", "Actions"
            }
        ) {
        ...
        jTable1_GestionCotisations.setRowHeight(40);
        jTable1_GestionCotisations.setSelectionBackground(new java.awt.Color(57, 137, 121));
        jScrollPane1.setViewportView(jTable1_GestionCotisations);
        if (jTable1_GestionCotisations.getColumnModel().getColumnCount() > 0) {
            jTable1_GestionCotisations.getColumnModel().getColumn(0).setMinWidth(30);
            jTable1_GestionCotisations.getColumnModel().getColumn(0).setPreferredWidth(30);
            jTable1_GestionCotisations.getColumnModel().getColumn(0).setMaxWidth(35);
            jTable1_GestionCotisations.getColumnModel().getColumn(1).setMinWidth(185);
            jTable1_GestionCotisations.getColumnModel().getColumn(1).setPreferredWidth(185);
            jTable1_GestionCotisations.getColumnModel().getColumn(1).setMaxWidth(190);
        }

        TableauDeBordBlanc2.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        TableauDeBordBlanc2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_coins_65px.png"))); // NOI18N
        TableauDeBordBlanc2.setText("Gestion cotisations");
        ...
        jButton1.setText("Enregistrer une cotisation");
        ...
        jLabel1.setText("Rechercher cotisation :");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        // Appel de la méthode pour charger les données de la table "cotisations"
        chargerDonneesCotisations();
        Gestion_cotisations GestionUtilisateurs = new Gestion_cotisations();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestion_cotisations().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable1_GestionCotisations;
