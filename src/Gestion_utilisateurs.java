...
public class Gestion_utilisateurs extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Gestion_utilisateurs
     */
    public Gestion_utilisateurs () {
        ...
        this.setTitle("Gestion Utilisateurs");
    ...
    jPanelDropdownBlack.setEnabled(true);
        ...
        event = new TableActionEvent_Livres(){
            ...
            public void onDelete(int row) {
                ...
                System.out.println("Delete row : " + row);
                                ...
                                if(jTable1_GestionUtilisateurs.isEditing()){
                    jTable1_GestionUtilisateurs.getCellEditor().stopCellEditing();
                    
                }
                
                // Vérifier d'abord la taille actuelle du modèle de tableau
                int rowCount = jTable1_GestionUtilisateurs.getRowCount();
                
                
                // Afficher une boîte de dialogue de confirmation
                int response = JOptionPane.showConfirmDialog(Gestion_utilisateurs.this, "Êtes-vous sûr de vouloir supprimer cette ligne ?", "Confirmation de suppression", JOptionPane.YES_NO_OPTION);
            ...
            private void deleteRow(int row) {
                ...
                try {
                    ...
                    String query = "DELETE FROM utilisateurs WHERE idUtili=?";
                    ...
                    int idUtili = (int) jTable1_GestionUtilisateurs.getValueAt(row, 0);
                    ...
                    // Exécution de la requête
                        ...
                        if (rowsAffected > 0) {
                            ...
                            DefaultTableModel model = (DefaultTableModel) jTable1_GestionUtilisateurs.getModel();
                            model.removeRow(row);

                            // Faire apparaître une fenêtre de dialogue informant de la suppression réussie
                            JOptionPane.showMessageDialog(Gestion_utilisateurs.this, "L'utilisateur a été supprimée avec succès.", "Suppression réussie", JOptionPane.INFORMATION_MESSAGE);
                        } else {
                            // Si aucune ligne n'a été affectée, afficher un message d'erreur
                            JOptionPane.showMessageDialog(Gestion_utilisateurs.this, "Aucune ligne n'a été supprimée.", "Erreur de suppression", JOptionPane.ERROR_MESSAGE);
                        }
                    ...
                    JOptionPane.showMessageDialog(Gestion_utilisateurs.this, "Erreur lors de la suppression : " + ex.getMessage(), "Erreur", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        jTable1_GestionUtilisateurs.getColumnModel().getColumn(9).setCellRenderer(new TableActionCellRendue());
        jTable1_GestionUtilisateurs.getColumnModel().getColumn(9).setCellEditor(new TableActionsCellEditor(event));
         
        
    }
    // Affichage de la table utilisateurs
    private void chargerDonneesUtilisateurs() {
    PreparedStatement ps;
    ResultSet rs;
    
    // Table utilisateurs de la bdd bibliotheque
    ...
    private void initComponents() {
        ...
        jTable1_GestionUtilisateurs = new javax.swing.JTable();
        ...
        jTable1_GestionUtilisateurs.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "Prénom", "Nom", "Date de Naissance", "Adresse", "Téléphone", "Email ou login", "Mot de passe", "Fonction", "Actions"
            }
        ) {
        ...
        jTable1_GestionUtilisateurs.setRowHeight(40);
        jTable1_GestionUtilisateurs.setSelectionBackground(new java.awt.Color(57, 137, 121));
        jScrollPane1.setViewportView(jTable1_GestionUtilisateurs);
        if (jTable1_GestionUtilisateurs.getColumnModel().getColumnCount() > 0) {
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(0).setMinWidth(30);
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(0).setPreferredWidth(30);
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(0).setMaxWidth(35);
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(1).setMinWidth(185);
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(1).setPreferredWidth(185);
            jTable1_GestionUtilisateurs.getColumnModel().getColumn(1).setMaxWidth(190);
        }

        TableauDeBordBlanc2.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        TableauDeBordBlanc2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_groups_65px_3.png"))); // NOI18N
        TableauDeBordBlanc2.setText("Gestion utilisateurs");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_add_user_20px.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(TableauDeBordBlanc2, javax.swing.GroupLayout.PREFERRED_SIZE, 723, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addContainerGap())
            .addComponent(jPanel2Biblio, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         // Appel de la méthode pour charger les données de la table "utilisateurs"
        chargerDonneesUtilisateurs();
        Gestion_utilisateurs GestionUtilisateurs = new Gestion_utilisateurs();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gestion_utilisateurs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jTable1_GestionUtilisateurs;
