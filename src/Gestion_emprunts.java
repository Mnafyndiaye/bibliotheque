 ...
 * @author DELL
 */
public class Gestion_emprunts extends javax.swing.JFrame {
    ...
    public Gestion_emprunts() {
        ...
        this.setTitle("Gestion Emprunts");
    ...
    jPanelDropdownBlack.setEnabled(true);
        ...
        jTable1_GestionEmprunts.getColumnModel().getColumn(6).setCellRenderer(new TableActionCellRendue());
        jTable1_GestionEmprunts.getColumnModel().getColumn(6).setCellEditor(new TableActionsCellEditor(event));
      
    }
    // Affichage des données de la table emprunts
    ...
    try {
        ...
        DefaultTableModel model = (DefaultTableModel) jTable1_GestionEmprunts.getModel();
        model.setRowCount(0);
        
        while (rs.next()) {
            Object[] row = {
                rs.getInt("idEmprunt"),
                rs.getString("idUtili"),
                rs.getString("idLivres"),
                rs.getDate("dateEmprunt"),
                rs.getDate("dateRetourPrevue"),
                rs.getString("etatEmprunt"),
            };
            model.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        jTable1_GestionEmprunts = new javax.swing.JTable();
        ...
        jLabelDéconnexion1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelDéconnexion1MouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
        ...
        jTable1_GestionEmprunts.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "idUtilisateur", "idLivres", "Date Emprunt", "Date de Retour Prévue", "Etat Emprunt", "Actions"
            }
        ) {
        ...
        jTable1_GestionEmprunts.setRowHeight(40);
        jTable1_GestionEmprunts.setSelectionBackground(new java.awt.Color(57, 137, 121));
        jScrollPane1.setViewportView(jTable1_GestionEmprunts);

        TableauDeBordBlanc2.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N
        TableauDeBordBlanc2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_sell_filled_65px.png"))); // NOI18N
        TableauDeBordBlanc2.setText("Gestion emprunts");
        ...
        jButton1.setText("Enregistrer un emprunt");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jPanel2Biblio, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jPanelDropdownBlack, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(jPanel2Biblio, javax.swing.GroupLayout.DEFAULT_SIZE, 776, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        // Appel de la méthode pour charger les données de la table "emprunts"
        chargerDonneesEmprunts();
        Gestion_emprunts GestionEmprunts = new Gestion_emprunts();
        GestionEmprunts.setVisible(true);
    ...
    private void jLabelDéconnexion1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelDéconnexion1MouseClicked
        // TODO add your handling code here:
                dispose();
        //System.exit(0);
    }//GEN-LAST:event_jLabelDéconnexion1MouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gestion_emprunts().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable1_GestionEmprunts;
